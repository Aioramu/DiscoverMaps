...
urlpatterns = [
    ...
    url(r'^api/reccomendedV2/$',views.recomendationV2,name='regs'),
    url(r'^api/reg/$',views.NewUser,name='regs'),
    url(r'^api/delete/$',views.delete_like,name='del'),
    ...
    url(r'^api/festival/$', views.getfestival),
    url(r'^api/kids/$', views.getkids),
    url(r'^api/theater/$', views.gettheater),
